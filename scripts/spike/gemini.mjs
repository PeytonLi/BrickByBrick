// Spike (b)+(c): confirm Gemini 3.5 Pro (strong solver) and Gemma 4 (weak solver)
...
const STRONG = env.STRONG_MODEL || 'gemini-3.5-pro'
const WEAK = env.WEAK_MODEL || 'gemma-4-9b-it'
