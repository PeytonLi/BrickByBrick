...
export const AgentEventSchema = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('strong_fix_generated'), code: z.string(), diff: z.string() }),
  ...
  z.object({ type: z.literal('pair_rejected'), reason: PairRejectReasonSchema }),
  z.object({ type: z.literal('recipe_mutated'), patch: GenerationConfigSchema.partial() }),
